...
const Plots = () => {
    ...
    console.log(page);
    useEffect(() => {
        fetchPlotsTypeProperties(page, dispatch);
    }, [page])
    return (
        <>
            ...
            <div className="container my-5">
                ...
                {properties && properties.map((val, ind) => {
                    return (
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8 right-side-details">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-danger">{val.price}</p>
...
const fetchPlotsTypeProperties = async (page, dispatch) => {
    try {
        const config = {
            headers: {
        ...
        const response = await axios.get(`/fetch_plots_with_pagination/${page}`, config);
